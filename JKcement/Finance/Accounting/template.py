...
<head>
    ...
    <style>
        ...
        /* Sliders */
        .date-slider-wrapper .slider-container { background: #F0E6D2!important; border-radius: 10px; }
    ...
    <div class="main">
        <div class="top-nav">
            <div>
                ...
                <h4 id="exc-title" style="margin: 5px 0 0 0; font-size: 13px; color: #7A6B58; font-weight: 700; text-transform: uppercase; opacity: 0.8;"></h4>
            </div>
...
const CC = ['#3C332A', '#D4AF37', '#7A6B58', '#E8C84A', '#5C4D3C', '#C8B88A', '#A69060'];
    ...
    let chartConfig = {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: type === 'line' ? {target: 'origin', above: 'rgba(60,51,42,0.05)'} : false,
                tension: 0.4
            }]
        },
        options: {
