# Finance/Spend_Analysis/FJSP20.py — Spend analysis_Direct expenses with Production
# -----------------------------------------------------
# AXIS ACCESS:
...
#   Column -> X: Plant                    | Y: Sum(Net Order Value)
# -----------------------------------------------------
...
CONFIG = {
    "id": "FJSP20",
    "name": "Spend analysis_Direct expenses with Production",
    "active_exceptions": [
    ...
    "columns": {
        "amount":   ["Net Order Value in PO Currency", "Net Price in Purchasing Document", "Amount"],
        "vendor":   ["Vendor Name", "Vendor Account Number"],
        "date":     ["Purchasing Document Date", "Date on Which Record Was Created"],
        "gl":       ["Plant", "Purchasing Organization"],
        "company":  ["Company Code", "Name of Company"],
        "document": ["Purchasing Document Number"],
        "doctype":  ["Purchasing Document Type", "Purchasing Document Category"]
    },
                "cards": [
    ...
    "charts": [
        ...
        {"id": "c4", "type": "doughnut", "x": "gl", "agg": "count", "title": get_chart_title("Plant")},
        {"id": "c5", "type": "bar", "x": "gl", "y": "amount", "agg": "sum", "top_n": 10, "title": get_chart_title("Plant", "Amount", top_n=10)}
    ]
}
...
def get_data(exc_id):
    paths = [
        f"data_files/FJSP20_Exception0{exc_id}.csv",
        f"data_files/FJSP20_Exception{exc_id}.csv"
    ]
