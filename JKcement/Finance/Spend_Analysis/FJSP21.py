# Finance/Spend_Analysis/FJSP21.py — Spend analysis_Freight
# -----------------------------------------------------
# AXIS ACCESS:
...
def get_data(exc_id):
    paths = [
        f"data_files/FJSP21_Exception0{exc_id}.csv",
        f"data_files/FJSP21_Exception{exc_id}.csv"
    ]
