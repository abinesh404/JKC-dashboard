...
<head>
    ...
    <style>
        ...
        .side-item { position:relative; padding:12px 20px; margin:4px 0; border-radius:30px 0 0 30px; cursor:pointer; font-size:11px; color:#6DD5D3; transition:all 0.2s ease; font-weight:600; }
        ...
        .kpi-lbl { font-size:10px; color:#6DD5D3; text-transform:uppercase; font-weight:700; margin-top:8px; opacity:0.9; }
        ...
        .date-slider-wrapper .slider-container { background:#B2E4E3!important; border-radius:10px; }
    ...
    <div class="main">
        <div class="top-nav">
            <div>
                ...
                <h4 id="exc-title" style="margin: 5px 0 0 0; font-size: 13px; color: #636E72; font-weight: 700; text-transform: uppercase; opacity: 0.8;"></h4>
            </div>
...
const CC = ['#2D3436','#00CEC9','#636E72','#00B5B0','#4A5568','#81ECEC','#74B9FF'];
