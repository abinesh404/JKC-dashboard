# Payroll/SoD/PJSO3.py - SoD Check_Category3 - BKPF and BSEG
# INSIGHT CONFIG
...
CONFIG = {
    "id": "PJSO3",
    "name": "SoD Check_Category3 - BKPF and BSEG",
...
def get_data(exc_id):
    paths = [
        rf"D:\off\JKC Dashboard\output\PJSO3_Exception{int(exc_id):02}.csv"
    ]
