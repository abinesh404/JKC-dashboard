# Payroll/SoD/PJSO4.py - SoD Check_Category4 - KNA1 and VBRK
# INSIGHT CONFIG
...
CONFIG = {
    "id": "PJSO4",
    "name": "SoD Check_Category4 - KNA1 and VBRK",
...
def get_data(exc_id):
    paths = [
        rf"D:\off\JKC Dashboard\output\PJSO4_Exception{int(exc_id):02}.csv"
    ]
