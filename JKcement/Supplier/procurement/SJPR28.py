# Supplier/procurement/SJPR28.py — Same Transaction & Group PO and Non-PO Invoices Raised
# -----------------------------------------------------
    ...
    "active_exceptions": [
        {
            "id": "1",
            "label": "Exception 01",
            "title": get_exception_title("PO vs Non-PO Based Transactions"),
            "cards": [
                {
                    "id": "k1",
                    "label": "Companies",
...
def get_data(exc_id):
    paths = [
        f"data_files/SJPR28_Exception0{exc_id}.csv",
        f"data_files/SJPR28_Exception{exc_id}.csv"
    ]
