# Supplier/procurement/SJPR55.py — Same Transaction & Group PO & Non-PO Invoices Raised
# -----------------------------------------------------
    ...
    "active_exceptions": [
        {
            "id": "1",
            "label": "Exception 01",
            "title": get_exception_title("Group Accounts for which PO & Non-PO Invoices have been Raised"),
            "cards": [
                {
                    "id": "k1",
                    "label": "Companies",
        ...
        },
        {
            "id": "2",
            "label": "Exception 02",
            "title": get_exception_title("GL & Group Account Numbers for which PO & Non-PO Invoices have been Raised"),
            "cards": [
                {
                    "id": "k1",
                    "label": "Companies",
...
def get_data(exc_id):
    paths = [
        f"data_files/SJPR55_Exception0{exc_id}.csv",
        f"data_files/SJPR55_Exception{exc_id}.csv"
    ]
