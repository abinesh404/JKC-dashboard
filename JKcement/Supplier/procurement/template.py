# Supplier/procurement/template.py
# -------------------------------------------------------------
# TEMPLATE ENGINE — Procurement Blue Theme
# -------------------------------------------------------------
...
<head>
    ...
    <style>
        ...
        tr:hover { background: #EBF7FF; }

        /* Sliders */
        .date-slider-wrapper .slider-container { background: #C1E8FF!important; border-radius: 10px; }
    ...
    <div class="main">
        <div class="top-nav">
            <div>
                ...
                <h4 id="exc-title" style="margin: 5px 0 0 0; font-size: 13px; color: #5483B3; font-weight: 700; text-transform: uppercase; opacity: 0.8;"></h4>
            </div>
...
// Fixed function name to match template structure
