...
<head>
    ...
    <style>
        ...
        .side-item { position:relative; padding:12px 20px; margin:4px 0; border-radius:30px 0 0 30px; cursor:pointer; font-size:11px; color:#B8E600; transition:all 0.2s ease; font-weight:600; }
        ...
        .kpi-lbl { font-size:10px; color:#B8E600; text-transform:uppercase; font-weight:700; margin-top:8px; opacity:0.9; }
        ...
        .date-slider-wrapper .slider-container { background:#E6F2B3!important; border-radius:10px; }
    ...
    <div class="main">
        <div class="top-nav">
            <div>
                ...
                <h4 id="exc-title" style="margin: 5px 0 0 0; font-size: 13px; color: #666666; font-weight: 700; text-transform: uppercase; opacity: 0.8;"></h4>
            </div>
...
const CC = ['#000000','#CCFF00','#666666','#A6D600','#333333','#E6FF80','#99CC00'];
